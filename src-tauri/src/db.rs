...
CREATE TABLE IF NOT EXISTS tasks (
  ...
  interval_max INTEGER NOT NULL DEFAULT 20,
  batch_size_min INTEGER NOT NULL DEFAULT 6,
  batch_size_max INTEGER NOT NULL DEFAULT 8,
  batch_pause_min INTEGER NOT NULL DEFAULT 180,
  batch_pause_max INTEGER NOT NULL DEFAULT 300,
